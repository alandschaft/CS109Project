...
A search server for the CS 109 Clinical Trials final project which can easily be deployed to Heroku.
...
- skipped_terms - list of terms that where shown to the user, but the user clÌcked "next" - i.e. did not select. Initialized empty.
...
Web API: Visit https://cs109-clinical-trialst-search.herokuapp.com/sessions/new to obtain session key
...
Web API: https://cs109-clinical-trialst-search.herokuapp.com/sessions/{your session key}/next
...
https://cs109-clinical-trialst-search.herokuapp.com/sessions/{your session key}/select/{term}
